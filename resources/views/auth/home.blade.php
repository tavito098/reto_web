        ...
        <div class="content-body">
            <div class="row">
                <div class="col-xl-3 col-lg-6 col-12">
                    <div class="card pull-up" onclick="window.location.replace('/login')">
                ...
                <div class="col-xl-3 col-lg-6 col-12">
                    <div class="card pull-up" onclick="window.location.replace('/folder-tree')">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h3 class="success">ARBOL DE CARPETAS</h3>
                                    </div>
                                    <div>
                                        <i class="icon-folder-alt success font-large-2 float-right"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
